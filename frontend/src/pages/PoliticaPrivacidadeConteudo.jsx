...
/**
 * Texto integral da Política de Privacidade, extraído para um
 * componente próprio para poder ser reaproveitado tanto na página
 * dedicada (/politica-de-privacidade) quanto dentro do modal aberto
 * a partir da tela de Cadastro.
 */
function PoliticaPrivacidadeConteudo() {
  return (
    <>
...
export default PoliticaPrivacidadeConteudo
